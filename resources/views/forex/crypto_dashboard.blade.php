...
@section('scripts')
    ...
    <script>
        ...
        var l_arr = ["BTCUSD","LTCUSD","ETHUSD","RiPUSD"];
        var color_code={"BTCUSD":"rgba(255, 99, 132, 1)","LTCUSD":"red","ETHUSD":"#e6e600", "RiPUSD":"rgba(75, 192, 192, 1)"};
        var color;
        ...
        function updatechart(){
            ...
            request.open('get', 'crypto_dashboard_test');
                request.onload = () => {
