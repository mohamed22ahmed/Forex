...
@section('scripts')
    ...
    <script>
        ...
        var l_arr = ["Oil","Dji","Gold","DAX","ND100"];
        var color_code={"Oil":"rgba(255, 99, 132, 1)","DAX":"red","Gold":"#e6e600", "EUR":"rgba(75, 192, 192, 1)", "ND100":"rgba(153, 102, 255, 1)", "Dji":"rgb(115, 230, 0)"};
        var color;
        ...
        function updatechart(){
            ...
            request.open('get', 'spot_dashboard_test');
                request.onload = () => {
