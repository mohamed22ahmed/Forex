...
@section('scripts')
    ...
    <script>
        ...
        var l_arr = ["DAX","Dji","ND100","AUS200","US500"];
        var color_code={ "Dji":"red","AUS200":"#e6e600", "US500":"rgba(75, 192, 192, 1)", "ND100":"rgba(153, 102, 255, 1)", "ESP35":"rgb(115, 230, 0)","JPN225":"blue","China50":"orange","HKG33":"white","Dax":"rgba(255, 99, 132, 1)","STOXX50":"#993366"};
        var color;
        ...
        function updatechart(){
            ...
            request.open('get', 'stocks_dashboard_test');
                request.onload = () => {
