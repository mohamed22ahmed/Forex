...
<body>
    ...
    <div class="page-content">
        <header>
            <div class="container">
                <nav>
                    <div class="nav__img" style="margin-top:-50px">
                        <img src="{{ asset('website_home/imag/logo.png') }}" alt="logo" class="nave__photo" style="width: 200px;">
                    </div>
                    <div class="nav__join p-2" style="margin-top:50px;">
                        <button class="btn btn-white join-us" style="border-radius: 30px;" onclick="x()">Join Us</button>
                    </div>
                </nav>
            </div>
        </header>
        ...
        @if(session('logged'))
            <div class="row" style="font-size:20px">
                ...
                <div class="col-md-4 text-center alert alert-danger" style="color:red">
                    {{ session('logged') }}
                </div>
                <div class="col-md-4"></div>
            </div>
        ...
        <div class="content-cover">
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-8 offset-md-2 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0s" style="margin-top: 110px;padding: 40px;">
        ...
        <div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 wow fadeInUp card-cover" data-wow-duration="2s" data-wow-delay="0s" style="display: none;">
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="{{ asset('start_page/img/icon_login.svg') }}" alt="" style="height: 6rem;">
        ...
        <div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 wow fadeInUp card-cover-reg" data-wow-duration="2s" data-wow-delay="0s" style="display: none;">
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    @endif
                    <form class="form"  method="POST" role="form" action="/signup">
                        @csrf
                        <div class="form-group">
